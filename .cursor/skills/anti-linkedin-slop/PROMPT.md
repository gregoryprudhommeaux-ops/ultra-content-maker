...
Rewrite: thèse nette → **un** critère de qualification asymétrique (pas 3) → conséquence concrète → drop quotes inventées + dig + triade → close sans packaging → voix + hedge + longueur de § irrégulière. Pas de teaser produit sauf brief.
...
— OK · not-X-but-Y · triplets · même×3 inline · cadence · densité · voix · hedge · verbes nets · mot courant · pas inventé · ±15% · pas télégraphique · close ouverte · pas teaser produit hors brief · test feed IA
